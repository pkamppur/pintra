...
class MyHomePage extends StatefulWidget {
  MyHomePage({Key? key, required this.title, required this.board})
      : super(key: key);
  ...
  final String title;
  final Future<Board> board;

  @override
  _MyHomePageState createState() => _MyHomePageState(board: board);
}

class _MyHomePageState extends State<MyHomePage> {
  late Future<Board> board;

  _MyHomePageState({required this.board});
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Board>(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              return BoardView(board: snapshot.data!);
